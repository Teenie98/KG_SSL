...
class KGAT(KnowledgeRecommender):
    ...
    def calculate_loss(self, interaction):
        ...
        cts_embedding_1 = user_all_embeddings_1[torch.tensor(user_rand_samples).type(torch.long)] #cts_embedding_1 = user_all_embeddings_1[torch.tensor(user_rand_samples)]
        cts_embedding_2 = user_all_embeddings_2[torch.tensor(user_rand_samples).type(torch.long)] #cts_embedding_2 = user_all_embeddings_2[torch.tensor(user_rand_samples)]

        e_cts_embedding_1 = entity_all_embeddings_1[torch.tensor(entity_rand_samples).type(torch.long)] #e_cts_embedding_1 = entity_all_embeddings_1[torch.tensor(entity_rand_samples)]
        e_cts_embedding_2 = entity_all_embeddings_2[torch.tensor(entity_rand_samples).type(torch.long)] #e_cts_embedding_2 = entity_all_embeddings_2[torch.tensor(entity_rand_samples)]
